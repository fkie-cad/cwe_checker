...
public class Instruction {
    ...
    private int size;
    private ArrayList<PcodeOp> pcode_ops = new ArrayList();
    private ArrayList<String> potential_targets;
    private String fall_through = null;


    public Instruction(Instruction instruction, VarnodeContext context) {
        ...
        for (int i = 0; i < pcodes.length; i++) {
            pcode_ops.add(new PcodeOp(i, pcodes[i], context));
