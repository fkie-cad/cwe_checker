...
fn test_get_fall_through_target() {
    ...
    let mut instr =
        Instruction::mock("0x1000", ["CALLIND ram_0x1234_4", "RETURN register_EAX_4"]);
    instr.fall_through = Some("0x1010".into());
    assert_eq!(
        instr.pcode_ops[0].get_fall_through_target(&instr).unwrap(),
        Tid::mock("blk_0x1000_1")
...
fn test_create_branch() {
    let instr = Instruction::mock("0x1000", ["BRANCH ram_0x1234_4"]);
    assert_eq!(
    ...
    let mut instr = Instruction::mock("0x1000", ["BRANCH const_0x2_4"]);
    instr.fall_through = Some("0x1001".into());
    assert_eq!(
        instr.pcode_ops[0].into_ir_jump(&instr),
        Term {
...
fn test_create_branch_indirect() {
    let instr = Instruction::mock("0x1000", ["BRANCHIND register_pc_4"]);
    assert_eq!(
        instr.pcode_ops[0].into_ir_jump(&instr),
        Term {
            tid: Tid::mock("instr_0x1000_0"),
...
#[test]
fn test_create_call() {
    let mut instr = Instruction::mock("0x1000", ["CALL ram_0x1234_4"]);
    instr.fall_through = Some("0x1001".into());
    assert_eq!(
        instr.pcode_ops[0].into_ir_jump(&instr),
        Term {
...
fn test_create_call_indirect() {
    let mut instr = Instruction::mock("0x1000", ["CALLIND register_EAX_4"]);
    instr.fall_through = Some("0x1001".into());
    assert_eq!(
        instr.pcode_ops[0].into_ir_jump(&instr),
        Term {
...
fn test_create_return() {
    let mut instr = Instruction::mock("0x1000", ["RETURN register_EAX_4"]);
    instr.fall_through = Some("0x1001".into());
    assert_eq!(
        instr.pcode_ops[0].into_ir_jump(&instr),
        Term {
...
fn test_create_call_other() {
    let mut instr = Instruction::mock("0x1000", ["CALLOTHER register_EAX_4"]);
    instr.fall_through = Some("0x1001".into());
    assert_eq!(
        instr.pcode_ops[0].into_ir_jump(&instr),
        Term {
