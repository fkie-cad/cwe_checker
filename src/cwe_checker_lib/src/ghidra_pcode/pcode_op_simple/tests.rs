...
impl PcodeOp {
    ...
    pub fn mock(pcode_op: &str) -> PcodeOp {
        ...
        let input0 = Varnode::mock(components.next().unwrap());
        let input1 = components
            .next()
            .map(|varnode| Varnode::mock(varnode));
...
fn test_pcode_op_simple_mock() {
    assert_eq!(
        PcodeOp::mock("register_RAX_8 INT_ADD register_RBX_8 register_RCX_8"),
        PcodeOp {
            pcode_index: 0,
            ...
            input2: None,
            output: Some(Varnode::mock("register_RAX_8"))
        }
    )
}
...
impl PcodeOp {
    pub fn with_mnemonic(&self, mnemonic: PcodeOperation) -> PcodeOp {
        PcodeOp {
    ...
    pub fn with_index(mut self, index: u64) -> PcodeOp {
...
fn test_pcode_op_has_implicit_load() {
    let pcode_op = PcodeOp::mock("register_RAX_8 INT_ADD ram_0x42_8 register_RAX_8");
    assert!(pcode_op.has_implicit_load());
    let pcode_op = PcodeOp::mock("STORE const_0x1b1_8 ram_0x42_8 register_RAX_8");
    assert!(pcode_op.has_implicit_load());
    let pcode_op = PcodeOp::mock("STORE const_0x1b1_8 register_RAX_8 ram_0x42_8");
    assert!(pcode_op.has_implicit_load());
    // No implicit loads
    let pcode_op = PcodeOp::mock("STORE const_0x1b1_8 register_RAX_8 register_RAX_8");
    assert!(!pcode_op.has_implicit_load());
    let pcode_op = PcodeOp::mock("ram_0x42_8 INT_ADD register_RAX_8 register_RAX_8");
    assert!(!pcode_op.has_implicit_load());
}
...
fn test_implicit_load_translation() {
    ...
    let mut instr = Instruction::mock("0x1000", ["ram_0x10_8 INT_SUB ram_0x20_8 ram_0x30_8"]);
    ...
    let mut instr = Instruction::mock(
        "0x1000",
...
#[test]
fn test_create_load() {
    let pcode_op = PcodeOp::mock("register_RAX_8 LOAD space_id_8 const_0x0012345_8");
    assert_eq!(
...
fn test_create_load_no_source() {
    PcodeOp::mock("register_RAX_8 LOAD space_id_8").create_load(&"0x123".to_string());
}

#[test]
#[should_panic]
fn test_create_load_no_output() {
    PcodeOp::mock("LOAD space_id_8 const_0x200_8").create_load(&"0x123".to_string());
}

#[test]
#[should_panic]
fn test_create_load_target_not_var() {
    PcodeOp::mock("const_0x4321_8 LOAD space_id_8 const_0x200_8")
        .create_load(&"0x123".to_string());
}

#[test]
fn test_create_store() {
    let pcode_op = PcodeOp::mock("STORE space_id_8 register_RAX_8 const_0x42_8");
    assert_eq!(
...
fn test_create_store_not_store() {
    PcodeOp::mock("STORE space_id_8 register_RAX_8").create_store(&"0x123".to_string());
}

#[test]
#[should_panic]
fn test_create_store_from_ram() {
    PcodeOp::mock("STORE space_id_8 const_4321_8 ram_0xFFFF01_8")
        .create_store(&"0x123".to_string());
}

#[test]
fn test_create_subpiece() {
    let op = PcodeOp::mock("register_EAX_4 SUBPIECE const_0xAABBCCDD_8 const_0x3_1");
...
fn test_create_subpiece_with_non_constant() {
    PcodeOp::mock("register_EAX_4 SUBPIECE const_0xABCDEF_8 register_RAX_8")
        .create_subpiece(&"0x1234".to_string());
}

#[test]
fn test_create_unop() {
    let op = PcodeOp::mock("register_RAX_8 INT_NEGATE register_RAX_8");
...
fn test_create_unop_not_expression_type() {
    PcodeOp::mock("register_RAX_8 CALL register_RAX_8").create_unop(&"0xFFFF".to_string());
}

#[test]
#[should_panic]
fn test_create_unop_not_unop_type() {
    PcodeOp::mock("register_RAX_8 INT_ADD register_RAX_8").create_unop(&"0xFFFF".to_string());
}

#[test]
fn test_create_biop() {
    let op = PcodeOp::mock("register_RAX_8 INT_ADD register_RAX_8 const_0xCAFE_8");
    let expected = Term {
        tid: Tid::mock("instr_0x1234_0"),
...
fn test_create_biop_not_biop_type() {
    PcodeOp::mock("register_RAX_8 COPY register_RAX_8 const_0xCAFE_8")
        .create_biop(&"0x1234".to_string());
}

#[test]
fn test_create_cast_op() {
    let op = PcodeOp::mock("register_RDI_8 INT_ZEXT const_0x1_1");
...
fn test_create_castop_not_castop_type() {
    PcodeOp::mock("register_RAX_8 COPY const_0x1_1").create_castop(&"0x1234".to_string());
}

#[test]
fn test_create_assign() {
    let op = PcodeOp::mock("register_ZF_1 COPY const_0x1_1");
    let expected = Term {
...
fn test_create_assign_not_copy_type() {
    PcodeOp::mock("register_ZF_1 BOOL_AND register_RAX_8 const_0xCAFE_4")
        .create_assign(&"0x1234".to_string());
}

#[test]
fn test_wrap_in_assign_or_store() {
    let op = PcodeOp::mock("register_EAX_4 INT_ADD register_EAX_4 const_0xCAFE_4");
    ...
    // test Store
    let op = PcodeOp::mock("ram_0x1000_4 INT_ADD register_EAX_4 const_0xCAFE_4");
...
fn test_wrap_in_assign_or_store_output_not_variable_nor_implicit_store() {
    PcodeOp::mock("const_0xFFFF_4 INT_ADD register_EAX_4 const_0xCAFE_4")
        .wrap_in_assign_or_store(&"0x1234".to_string(), expr!("0x1111:4"));
}

#[test]
fn test_into_ir_def() {
    let op = PcodeOp::mock("ram_0x10_8 INT_ADD register_RAX_8 ram_0x20_8");
