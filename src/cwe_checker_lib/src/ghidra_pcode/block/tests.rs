...
fn test_block_collect_jmp_targets() {
    let target_a = Varnode::mock("ram_0x1234_8");
    let target_b = Varnode::mock("ram_0xFFFFFFFF_8");
    let target_relative_next_op = Varnode::mock("const_0x1_8");
    ...
    let next_instr = Instruction::mock("0x1007".into(), Vec::<&str>::new());
    let blk = Block {
...
fn test_pcode_relative_jump_forward_jump() {
    ...
    */
    ...
    let instr = Instruction::mock("0x0100".into(), pcode_ops);
    let blk = Block {
        address: "0x0100".into(),
...
fn test_process_pcode_relative_jump_backward_jump() {
    ...
    let op_cbranch_backward = mock_pcode_op_cbranch(
        2,
        Varnode::mock("const_0xFFFFFFFF_4"),
        Varnode::mock("register_ZF_1"),
    );
    let pcode_ops = vec![
        "register_EAX_4 INT_ADD register_EAX_4 register_EAX_4",
    ...
    let instr = Instruction::mock("0x0200".into(), pcode_ops);
    let blk = Block {
        address: "0x0200".into(),
        instructions: vec![instr],
    };
