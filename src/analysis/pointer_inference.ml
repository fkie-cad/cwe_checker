...
external rs_run_pointer_inference_and_print_debug: Json_utils.SerdeJson.t -> unit = "rs_run_pointer_inference_and_print_debug"
...
let run (project: Project.t) (tid_map: Bap.Std.word Bap.Std.Tid.Map.t) : unit =
  ...
  let project_serde = Json_utils.SerdeJson.of_project project extern_symbols entry_points in
